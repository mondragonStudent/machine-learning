...
def problem_2():
    ...
    # 3. ndim
    print("\n 3. Number of Dimensions of :")
    print("Number of Dimensions of temperatures ", temperatures.ndim)
    ...
    print("\n 5. Entire third column:")
    print("Third column ", temperatures[:,2])

    # 6. first two rows, first three columns
    print("\n 6. First two rows, first three columns:")
    print("First two rows, first three columns ", temperatures[:2,:3])

    # 7. the value 85 by row and column index
    print("\n 7. The value 85 by row and column index:")
    print("Value 85 ", temperatures[2,2])
...
def problem_3():
    ...
    print("multiples of five to fifty: ", five_multiples)

    # 2. 10 evenly spaced values between 0 and 100
    ten_evenly_spaced = np.linspace(0, 100, 10)
    print("10 evenly spaced values between 0 and 100: ", np.round(ten_evenly_spaced,2))

    # 3. 3 x 4 zeros
    three_by_four_zeros = np.zeros((3,4))
    print("3 x 4 zeros: ", three_by_four_zeros)

    # 4. 2 x 5 all 25
    two_by_five_25 = np.full((2,5), 25)
    print("2 x 5 all 25: ", two_by_five_25)

    # 5. 4 x 4 identity
    four_by_four_identity = np.eye(4)
    print("4 x 4 identity: ", four_by_four_identity)
